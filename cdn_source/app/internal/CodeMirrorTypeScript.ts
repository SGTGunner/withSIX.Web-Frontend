...
CodeMirror.defineMode("javascript", function(config, parserConfig) {
    ...
    var cx = { state: null, column: null, marked: null, cc: null, stream: null };
    ...
    function maybetype(type): any {
        if (type == ":") return cont(typedef);
        return pass();
    }

    function typedef(type): any {
        if (type == "variable") {
    ...
    function vardef1(type, value): any {
        if (type == "variable") {
            register(value);
