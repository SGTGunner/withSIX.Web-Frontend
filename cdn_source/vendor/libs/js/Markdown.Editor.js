...
(function() {
    ...
    Markdown.Editor = function(markdownConverter, idPostfix, options) {
        ...
        this.run = function(customId) {
            if (panels)
                return; // already initialized

            panels = customId != undefined ? new PanelCollection2(customId) : new PanelCollection(idPostfix);
    ...
    function PanelCollection2(inputId) {
        this.buttonBar = doc.getElementById("wmd-toolbar-" + inputId);
        this.preview = doc.getElementById("wmd-preview-" + inputId);
        this.input = doc.getElementById(inputId);
    };
